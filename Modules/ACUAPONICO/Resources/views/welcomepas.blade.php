            ...
            <div class="card shadow-lg border-0">
                <div class="card-header bg-gradient-info text-white">
                    <h5 class="mb-0">
                        ...
                        Producción vs Mortalidad de Plantas por Sistema ({{ $currentYear }})
                    </h5>
                </div>
                <div class="card-body">
            ...
            <div class="card shadow-lg border-0">
                <div class="card-header bg-gradient-success text-white">
                    <h5 class="mb-0">
                        ...
                        Eficiencia de Producción vs Mortalidad ({{ $currentYear }})
                    </h5>
                </div>
                <div class="card-body">
            ...
            <div class="card shadow-lg border-0">
                <div class="card-header bg-gradient-warning text-white">
                    <h5 class="mb-0">
                        ...
                        Comparación Mensual de Producción vs Mortalidad de Plantas ({{ $currentYear }})
                    </h5>
                </div>
                <div class="card-body">
        ...
        <div class="col-12">
            <div class="alert alert-info border-0 shadow-sm">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h6 class="alert-heading mb-1">Análisis de Eficiencia {{ $currentYear }}</h6>
                        <p class="mb-0">Las gráficas muestran la comparación entre producción (cultivos cosechados) y mortalidad de plantas para cada sistema acuapónico durante el año {{ $currentYear }}. Una mayor eficiencia indica mejor gestión del sistema con menor pérdida de plantas.</p>
                    </div>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const productionVsMortalityData = @json($productionVsMortalityData);
    const systemEfficiency = @json($systemEfficiency);
        ...
        document.querySelectorAll('[id^="loadingChart"]').forEach(el => {
            el.innerHTML = `
                <div class="text-center py-4">
                    ...
                    <h6 class="text-muted">No hay datos disponibles para {{ $currentYear }}</h6>
                    <p class="text-muted small">Los datos de producción y mortalidad de plantas aparecerán aquí una vez que se registren cultivos y seguimientos en el año {{ $currentYear }}.</p>
                </div>
            `;
        });
        return;
