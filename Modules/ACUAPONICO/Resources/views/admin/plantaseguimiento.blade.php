                ...
                <table id="seguimientoplantatable" class="table table-hover align-middle mb-0" style="min-width: 1100px; border: 1px solid #e3e6f0;">
                    ...
                    <tbody>
                        ...
                        <tr class="animate__animated animate__fadeIn" style="animation-delay: {{ $n * 0.03 }}s; border-bottom: 1px solid #e3e6f0; transition: all 0.3s ease;">
                            ...
                            <td class="fw-medium py-3" style="border-right: 1px solid #e3e6f0;">{{ $sp->Tracking->date }}</td>
                            <td class="py-3" style="border-right: 1px solid #e3e6f0;">{{ $sp->Tracking->aquaponicSystem->name ?? 'Sin sistema' }}</td>
                            <td class="py-3" style="border-right: 1px solid #e3e6f0;">{{ $sp->Tracking->crops->species->name }}</td>
                            <td class="text-center fw-bold py-3" style="border-right: 1px solid #e3e6f0;">
                                <span class="badge bg-info rounded-pill px-3 py-2 shadow-sm">{{ $sp->plant_count }}</span>
                            </td>
                            <td class="text-center fw-bold py-3" style="border-right: 1px solid #e3e6f0;">
                                <span class="badge bg-primary rounded-pill px-3 py-2 shadow-sm">{{ $sp->height_cm }} cm</span>
                            </td>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <label class="color-option text-center">
                                ...
                                <span class="color-circle-modal" style="background-color: {{ $color }};" data-toggle="tooltip" title="{{ $nombre }}"></span>
                            </label>
                            @endforeach
                        </div>
                    </div>
...
<div class="modal fade" id="agregar" tabindex="-1" aria-labelledby="agregarLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="overflow: hidden;">
            ...
            <form action="{{ route('acuaponico.pasante.pasante.storetrackingplant') }}" method="POST" id="formAgregar">
                @csrf
