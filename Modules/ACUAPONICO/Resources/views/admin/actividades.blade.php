                ...
                <tbody>
                    ...
                    @forelse ($activities as $activity)
                        <tr>
                            ...
                            <td>
                                <button class="action-btn edit" data-toggle="modal" data-target="#editModal{{ $activity->id }}" title="Editar">
                ...
                <tbody>
                    ...
                    @foreach($evidenciasAdmin as $evidencia)
                        <tr>
                            ...
                            <td>
                                @if($evidencia->evidence && Storage::disk('public')->exists($evidencia->evidence))
                                    <button class="action-btn view" data-toggle="modal" data-target="#verPdfModal{{ $evidencia->id }}" title="Ver PDF">
...
@foreach($evidenciasAdmin as $evidencia)
<!-- PDF VIEW MODAL -->
<div class="modal fade" id="verPdfModal{{ $evidencia->id }}" tabindex="-1" role="dialog" aria-hidden="true">
