                ...
                <table id="resiembraTable" class="table table-hover align-middle mb-0" style="border: 1px solid #e3e6f0;">
                    ...
                    <tbody>
                        ...
                        <tr class="animate__animated animate__fadeIn" style="animation-delay: {{ $n * 0.03 }}s; border-bottom: 1px solid #e3e6f0; transition: all 0.3s ease;">
                            ...
                            <td class="py-3" style="border-right: 1px solid #e3e6f0;">
                                @if ($item->description)
                                <span class="text-muted" data-toggle="tooltip" title="{{ $item->description }}">{{ Str::limit($item->description, 30) }}</span>
                                @else
                            ...
                            <td class="text-center py-3" style="border-right: 1px solid #e3e6f0;">
                                <span class="badge bg-success rounded-pill px-3 py-2 shadow-sm pulse-active">{{ $item->status }}</span>
                            </td>
