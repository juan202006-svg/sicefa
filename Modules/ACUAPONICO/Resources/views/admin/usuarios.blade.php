        ...
        <form action="{{ route('acuaponico.admin.admin.updateUsuarios', $usuario->id) }}" method="POST">
            ...
            <div class="modal-content shadow-lg rounded-3">
                ...
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title w-100 text-center fw-bold" id="editModalLabel{{ $usuario->id }}">
                        <i class="fas fa-edit me-2"></i> Editar Usuario: 
                        <span class="user-name-display">{{ $usuario->first_name }} {{ $usuario->last_name }}</span>
                    </h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-info mb-4">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <span class="badge {{ $usuario->role == 'instructor' ? 'bg-warning text-dark' : 'bg-info text-dark' }} current-user-role">
                                    {{ ucfirst($usuario->role) }}
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label for="first_name_{{ $usuario->id }}" class="form-label fw-semibold d-flex align-items-center">
                                <i class="fas fa-user text-primary me-2"></i> Nombre
                            </label>
                            <input type="text" name="first_name" id="first_name_{{ $usuario->id }}" class="form-control" value="{{ $usuario->first_name }}" required>
                        </div>

                        <div class="col-md-6">
                            <label for="last_name_{{ $usuario->id }}" class="form-label fw-semibold d-flex align-items-center">
                                <i class="fas fa-user text-primary me-2"></i> Apellidos
                            </label>
                            <input type="text" name="last_name" id="last_name_{{ $usuario->id }}" class="form-control" value="{{ $usuario->last_name }}" required>
                        </div>

                        <div class="col-md-6">
                            <label for="role_{{ $usuario->id }}" class="form-label fw-semibold d-flex align-items-center">
                                <i class="fas fa-user-tag text-primary me-2"></i> Rol
                            </label>
                            <select name="role" id="role_{{ $usuario->id }}" class="form-select" required style="width: 100%;">
                        ...
                        <div class="col-md-6">
                            <label for="status_{{ $usuario->id }}" class="form-label fw-semibold d-flex align-items-center">
                                <i class="fas fa-toggle-on text-primary me-2"></i> Estado
                            </label>
                            <select name="status" id="status_{{ $usuario->id }}" class="form-select" required style="width: 100%;">
                        ...
                        <div class="col-12" style="margin-left: 35%;">
                            <label for="productive_unit_id_{{ $usuario->id }}" class="form-label fw-semibold d-flex align-items-center">
                                <i class="fas fa-building text-primary me-2"></i> Unidad Productiva
                            </label>
                            <select name="productive_unit_id" id="productive_unit_id_{{ $usuario->id }}" class="form-select" required>
                                <option value="">-- Seleccione --</option>
                                @foreach($unidades as $unidad)
