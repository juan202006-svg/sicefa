        ...
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div class="d-flex align-items-center">
                    ...
                    <small class="text-muted">Total de seguimientos: <?php echo e(count($seguimiento_resiembra)); ?></small>
                </div>
                ...
                <table id="seguimientoresiembra" class="table table-hover align-middle mb-0" style="border: 1px solid #e3e6f0;">
                    ...
                    <tbody>
                        ...
                        <tr class="animate__animated animate__fadeIn" style="animation-delay: <?php echo e($n * 0.03); ?>s; border-bottom: 1px solid #e3e6f0; transition: all 0.3s ease;">
                            ...
                            <td class="fw-medium py-3" style="border-right: 1px solid #e3e6f0;"><?php echo e($sr->date ?? 'N/A'); ?></td>
                            <td class="py-3" style="border-right: 1px solid #e3e6f0;"><?php echo e($sr->aquaponicSystem->name ?? 'Sin sistema'); ?></td>
                            <td class="py-3" style="border-right: 1px solid #e3e6f0;"><?php echo e($sr->resowing->crops->species->name ?? 'Sin cultivo'); ?></td>
                            <td class="text-center fw-bold py-3" style="border-right: 1px solid #e3e6f0;">
                                <span class="badge bg-info rounded-pill px-3 py-2 shadow-sm"><?php echo e($sr->plant_count ?? '0'); ?></span>
                            </td>
                            <td class="text-center py-3" style="border-right: 1px solid #e3e6f0;">
                                <span class="color-circle-large" style="background-color: <?php echo e($sr->color_tone ?? '#000'); ?>;"></span>
                            </td>
                            <td class="text-center fw-bold py-3" style="border-right: 1px solid #e3e6f0;"><?php echo e($sr->height_cm ? $sr->height_cm . 'cm' : 'N/A'); ?></td>
                            <td class="text-center fw-bold py-3" style="border-right: 1px solid #e3e6f0;"><?php echo e($sr->days_elapsed ?? '0'); ?></td>
                            <td class="text-center fw-bold py-3" style="border-right: 1px solid #e3e6f0;"><?php echo e($sr->growth ? $sr->growth . 'cm' : '0'); ?></td>
                            <td class="text-center fw-bold py-3" style="border-right: 1px solid #e3e6f0;">
                                <?php
                                    $percentage = $sr->comparison_percentage ?? 0;
                                    $badgeClass = $percentage >= 80 ? 'bg-success' : ($percentage >= 50 ? 'bg-warning' : 'bg-danger');
                                ?>
                                <span class="badge <?php echo e($badgeClass); ?> rounded-pill px-3 py-2 shadow-sm"><?php echo e($percentage); ?>%</span>
                            </td>
                            <td class="text-center fw-bold py-3" style="border-right: 1px solid #e3e6f0;">
                                <span class="badge bg-danger rounded-pill px-3 py-2 shadow-sm"><?php echo e($sr->mortality ?? '0'); ?></span>
                            </td>
                            <td class="py-3" style="border-right: 1px solid #e3e6f0;">
                                <?php if($sr->notes): ?>
                                <span class="text-muted" data-toggle="tooltip" title="<?php echo e($sr->notes); ?>"><?php echo e(Str::limit($sr->notes, 30)); ?></span>
                                <?php else: ?>
                            ...
                            <td class="text-center py-3">
                                <div class="d-flex justify-content-center action-buttons">
                                    ...
                                    <!-- Botón de Eliminar -->
                                    <button type="button" class="btn btn-action btn-delete btnEliminar mx-1" data-id="<?php echo e($sr->id); ?>">
                                        <div class="btn-icon">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="d-flex gap-3 justify-content-between">
                                    ...
                                    <label class="color-option">
                                        ...
                                        <span class="color-circle-modal" style="background-color: <?php echo e($color); ?>;"></span>
                                    </label>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
...
<div class="modal fade" id="agregar" tabindex="-1" aria-labelledby="agregarLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="overflow: hidden;">
            ...
            <form action="<?php echo e(route('acuaponico.pasante.pasante.storeresowingtracking')); ?>" method="POST" id="formAgregar">
                <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('acuaponico::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sicefa\Modules/ACUAPONICO\Resources/views/admin/registroseguimiento.blade.php ENDPATH**/ ?>