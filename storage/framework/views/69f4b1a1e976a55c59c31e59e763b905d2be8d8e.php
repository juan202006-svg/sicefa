...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    ...
    <div class="container-fluid" style="background-image: url('<?php echo e(asset('AdminLTE/dist/img/fondoaco.jpg')); ?>'); 
        ...
        <div class="w-100">
            ...
            <div class="bg-white p-5 rounded shadow" style="opacity: 1; height: auto; width: 100%; margin-top: 3%;">
                ...
                <div style="display: flex; align-items: center; gap: 50px; flex-wrap: wrap;">
                    ...
                    <div style="flex: 1; display: flex; flex-direction: column; justify-content: center;">
                        <!-- Título -->
                        <h1 style="font-family: Broadway; font-size: 45px; margin-bottom: 20px; color: #1e421e;">
                            <strong>GSA - Gestión de Sistemas Acuapónicos</strong>
                        </h1>
                ...
                <div class="d-flex justify-content-center align-items-start mt-5">
                    ...
                    <div class="d-flex flex-wrap gap-4 position-relative" style="width: 60%;">
                        ...
                        <div class="card shadow text-center d-flex flex-column justify-content-center align-items-center tarjeta-redonda"
                            ...
                            <i class="fas fa-spa fa-2x mb-2" style="color: #71ccef;"></i>
                        ...
                        <div class="card shadow text-center d-flex flex-column justify-content-center align-items-center tarjeta-redonda"
                            ...
                            <i class="fas fa-hand-holding-water fa-2x mb-2" style="color: #71ccef;"></i>
                        ...
                        <div class="card shadow text-center d-flex flex-column justify-content-center align-items-center tarjeta-redonda"
                            ...
                            <i class="fas fa-recycle fa-2x mb-2" style="color: #71ccef;"></i>
                        ...
                        <div class="card shadow text-center d-flex flex-column justify-content-center align-items-center tarjeta-redonda"
                            ...
                            <i class="fas fa-circle-notch fa-2x mb-2" style="color: #71ccef;"></i>
                    ...
                    <div class="card-body" style="width: 40%; margin-left: -3%;">
                        ...
                        <div class="acuaponic-timeline">
                            <div class="timeline-step">
                                <div class="step-icon text-white rounded-circle d-inline-flex align-items-center justify-content-center" style="width: 40px; height: 40px; margin-left: -38.2%; background-color: #71ccef;">
                            ...
                            <div class="timeline-arrow text-center my-2">
                                <i class="fas fa-arrow-down" style="color: #71ccef;"></i>
                            </div>

                            <div class="timeline-step">
                                <div class="step-icon text-white rounded-circle d-inline-flex align-items-center justify-content-center" style="width: 40px; height: 40px; background-color: #71ccef;">
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content" style="height: 100vh;">
                    <div class="modal-body p-4 d-flex flex-column align-items-center justify-content-center">
                        <h2 class="fw-bold mb-4" style="color: #71ccef;"><strong>Ciclo de Nutrientes en Acuaponía</strong></h2>
                        <div class="card bg-light shadow-sm rounded-3 p-4 w-100" style="max-width: 600px;">
                            ...
                            <!-- Process Description -->
                            <!-- Proceso Completo -->
                            <div class="bg-opacity-10 p-3 rounded-3" style="background-color: #e6f4fa;">
                                <h4 class="text-center fw-bold mb-3" style="color: #71ccef;">¿Cómo funciona este proceso?</h4>
        ...
        <div class="modal fade" id="modal2" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content" style="border-radius: 15px; overflow: hidden; border: none; box-shadow: 0 5px 20px rgba(0,0,0,0.2);">
                    <h2 class="modal-title text-center fw-bold m-0" style="color: #71ccef;">Fertilizante Natural en Acuaponía</h2>
                    <!-- Cuerpo del modal -->
                            ...
                            <div class="col-md-5 p-4 d-flex flex-column">
                                ...
                                <div class="mb-4">
                                    <div class="d-flex align-items-center mb-3">
                                        <div>
                                            <h4 class="m-0" style="color: #71ccef;">1. Desechos de peces</h4>
                                ...
                                <div class="mb-4">
                                    <div class="d-flex align-items-center mb-3">
                                        <div>
                                            <h4 class="m-0" style="color: #71ccef;">2. Transformación bacteriana</h4>
                                ...
                                <div class="mb-4">
                                    <div class="d-flex align-items-center mb-3">
                                        <div>
                                            <h4 class="m-0" style="color: #71ccef;">3. Nutrición vegetal</h4>
                                ...
                                <div class="bg-light p-3 rounded mt-auto">
                                    <div class="d-flex align-items-center mb-2">
                                        <i class="fas fa-balance-scale me-2 fs-4" style="color: #71ccef;"></i>
                                        <h5 class="m-0" style="color: #71ccef;">Ventajas vs. fertilizantes tradicionales</h5>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="d-flex align-items-start mb-2">
                                                <i class="fas fa-check-circle mt-1 me-2" style="color: #71ccef;"></i>
                                                <div>
        ...
        <div class="modal fade" id="modal3" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content border-0 rounded-4 overflow-hidden shadow-lg">
                    <!-- Cabecera -->
                    <div class="text-white text-center p-4" style="background-color: #71ccef;">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <div class="border rounded-3 p-3 h-100 text-center">
                                    <div class="text-white rounded-circle d-inline-flex align-items-center justify-content-center mb-2" style="width: 50px; height: 50px; background-color: #71ccef;">
                                        <span class="fw-bold fs-5">1</span>
                                    </div>
                                    <h5 class="fw-bold" style="color: #71ccef;">Filtro Mecánico</h5>
                            ...
                            <div class="col-md-4">
                                <div class="border rounded-3 p-3 h-100 text-center">
                                    ...
                                    <h5 class="fw-bold" style="color: #71ccef;">Biofiltro</h5>
                            ...
                            <div class="col-md-4">
                                <div class="border rounded-3 p-3 h-100 text-center">
                                    ...
                                    <h5 class="fw-bold" style="color: #71ccef;">Filtración Vegetal</h5>
                                    <p class="small mb-0">Las plantas absorben los nutrientes, devolviendo agua limpia a los peces.</p>
                                </div>
                            </div>
                        </div>
                        <!-- Ventajas destacadas -->
                        <div class="mt-4 p-3 rounded-3" style="background: linear-gradient(135deg, #e3f2fd, #e6f4fa);">
                            <h5 class="fw-bold mb-3 text-center" style="color: #71ccef;">
                                <i class="fas fa-check-circle me-2" style="color: #71ccef;"></i> Beneficios de la Purificación
                            </h5>
                            <div class="row">
                                <div class="col-md-6">
                                    <ul class="list-unstyled mb-0">
                                        <li class="mb-2">
                                            <i class="fas fa-leaf me-2" style="color: #71ccef;"></i>
                                            Agua saludable para peces y plantas.
                                        </li>
                                        <li class="mb-2">
                                            <i class="fas fa-recycle me-2" style="color: #71ccef;"></i>
                                ...
                                <div class="col-md-6">
                                    <ul class="list-unstyled mb-0">
                                        <li class="mb-2">
                                            <i class="fas fa-shield-alt me-2" style="color: #71ccef;"></i>
                                            Previene toxicidad y enfermedades.
                                        </li>
                                        <li class="mb-2">
                                            <i class="fas fa-seedling me-2" style="color: #71ccef;"></i>
        ...
        <div class="modal fade" id="modal4" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content border-0 rounded-4 overflow-hidden" style="box-shadow: 0 10px 30px rgba(0,0,0,0.15); border: 2px solid #71ccef;">
                    ...
                    <div class="text-white text-center p-4 position-relative" style="background-color: #71ccef;">
                        <div class="position-absolute top-0 start-0 w-100 h-100 overflow-hidden">
                            <div class="water-wave" style="position: absolute; bottom: -10px; left: 0; width: 200%; height: 100%; background: rgba(113,204,239,0.2); border-radius: 40%; animation: wave 10s linear infinite;"></div>
                        </div>
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="text-center mb-4 position-relative" style="height: 250px;">
                            ...
                            <div class="cycle-point" style="top: 20%; left: 30%;" data-step="1">
                                ...
                                <div class="point-label text-white" style="background-color: #71ccef;">Peces</div>
                            </div>
                            <div class="cycle-point" style="top: 30%; right: 20%;" data-step="2">
                                <div class="point-pulse"></div>
                                <div class="point-label text-white" style="background-color: #71ccef;">Bacterias</div>
                            </div>
                            <div class="cycle-point" style="bottom: 20%; right: 25%;" data-step="3">
                                <div class="point-pulse"></div>
                                <div class="point-label text-white" style="background-color: #71ccef;">Plantas</div>
                            </div>
                            <div class="cycle-point" style="bottom: 15%; left: 25%;" data-step="4">
                                <div class="point-pulse"></div>
                                <div class="point-label text-white" style="background-color: #71ccef;">Agua Limpia</div>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6 col-lg-3">
                                <div class="step-card" data-step="1">
                                    <div class="step-number" style="background-color: #71ccef;">1</div>
                                    <h5 style="color: #71ccef;">Desechos de Peces</h5>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="step-card" data-step="2">
                                    <div class="step-number" style="background-color: #71ccef;">2</div>
                                    <h5 style="color: #71ccef;">Transformación</h5>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="step-card" data-step="3">
                                    <div class="step-number" style="background-color: #71ccef;">3</div>
                                    <h5 style="color: #71ccef;">Nutrición Vegetal</h5>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="step-card" data-step="4">
                                    <div class="step-number" style="background-color: #71ccef;">4</div>
                                    <h5 style="color: #71ccef;">Agua Purificada</h5>
                                    <p class="small">El agua limpia retorna a los peces, completando el ciclo sostenible.</p>
                                </div>
                            </div>
                        </div>
                        <!-- Beneficios destacados -->
                        <div class="bg-opacity-10 p-3 rounded-3 mb-3" style="background-color: #e6f4fa;">
                            <h5 class="text-center mb-3" style="color: #71ccef;"><i class="fas fa-star me-2" style="color: #71ccef;"></i> Beneficios Clave</h5>
                            <div class="row text-center">
                                <div class="col-6 col-md-3 mb-2">
                                    <div class="p-2 bg-white rounded-2 h-100">
                                        <i class="fas fa-recycle fs-4 mb-2" style="color: #71ccef;"></i>
                                        <div class="fw-bold small">Sistema Circular</div>
                                    </div>
                                </div>
                                <div class="col-6 col-md-3 mb-2">
                                    <div class="p-2 bg-white rounded-2 h-100">
                                        <i class="fas fa-leaf fs-4 mb-2" style="color: #71ccef;"></i>
                                        <div class="fw-bold small">100% Orgánico</div>
                                    </div>
                                </div>
                                <div class="col-6 col-md-3 mb-2">
                                    <div class="p-2 bg-white rounded-2 h-100">
                                        <i class="fas fa-tint fs-4 mb-2" style="color: #71ccef;"></i>
                                        <div class="fw-bold small">Ahorro de Agua</div>
                                    </div>
                                </div>
                                <div class="col-6 col-md-3 mb-2">
                                    <div class="p-2 bg-white rounded-2 h-100">
                                        <i class="fas fa-fish fs-4 mb-2" style="color: #71ccef;"></i>
