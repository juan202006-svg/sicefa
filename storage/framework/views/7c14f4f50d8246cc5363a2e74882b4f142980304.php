        ...
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div class="d-flex align-items-center">
                    ...
                    <small class="text-muted">Total de seguimientos: <?php echo e(count($seguimientoPez)); ?></small>
                </div>
                ...
                <table id="seguimientopeztable" class="table table-hover align-middle mb-0" style="border: 1px solid #e3e6f0;">
                    ...
                    <tbody>
                        ...
                        <tr class="animate__animated animate__fadeIn" style="animation-delay: <?php echo e($n * 0.03); ?>s; border-bottom: 1px solid #e3e6f0; transition: all 0.3s ease;">
                            ...
                            <td class="fw-medium py-3" style="border-right: 1px solid #e3e6f0;"><?php echo e($sp->Tracking->date ?? 'Sin fecha'); ?></td>
                            <td class="py-3" style="border-right: 1px solid #e3e6f0;">
                                <?php if($sp->Tracking->crops->species->name ?? 'sin especie'): ?>
                                <span class="text-muted"><?php echo e($sp->Tracking->crops->species->name ?? 'sin especie'); ?></span>
                                <?php else: ?>
                                <span class="text-muted font-italic">Sin cultivo</span>
                                <?php endif; ?>
                            </td>
                            <td class="text-center fw-bold py-3" style="border-right: 1px solid #e3e6f0;">
                                <span class="badge bg-info rounded-pill px-3 py-2 shadow-sm"><?php echo e($sp->fish_count); ?></span>
                            </td>
                            <td class="text-center fw-bold py-3" style="border-right: 1px solid #e3e6f0;">
                                <span class="badge bg-warning rounded-pill px-3 py-2 shadow-sm"><?php echo e($sp->weight_gr); ?>gr</span>
                            </td>
                            <td class="text-center fw-bold py-3" style="border-right: 1px solid #e3e6f0;">
                                <span class="badge bg-success rounded-pill px-3 py-2 shadow-sm"><?php echo e($sp->biomass_gr); ?>gr</span>
                            </td>
                            <td class="text-center fw-bold py-3" style="border-right: 1px solid #e3e6f0;">
                                <span class="badge bg-primary rounded-pill px-3 py-2 shadow-sm"><?php echo e($sp->weight_gain_gr); ?>gr</span>
                            </td>
                            <td class="text-center py-3" style="border-right: 1px solid #e3e6f0;">
                                <?php if($sp->mortality > 0): ?>
                                <span class="badge bg-danger rounded-pill px-3 py-2 shadow-sm"><?php echo e($sp->mortality); ?></span>
                                <?php else: ?>
                                <span class="badge bg-secondary rounded-pill px-3 py-2 shadow-sm"><?php echo e($sp->mortality); ?></span>
                                <?php endif; ?>
                            </td>
...
<div class="modal fade" id="agregar" tabindex="-1" aria-labelledby="agregarLabel" aria-hidden="true">
    <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="overflow: hidden;">
            ...
            <form action="<?php echo e(route ('acuaponico.pasante.pasante.storetrackingfish')); ?>" method="POST" id="formAgregar">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('acuaponico::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sicefa\Modules/ACUAPONICO\Resources/views/admin/pezseguimiento.blade.php ENDPATH**/ ?>