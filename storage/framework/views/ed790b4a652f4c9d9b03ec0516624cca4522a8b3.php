                ...
                <table id="seguimientoplantatable" class="table table-hover align-middle mb-0" style="min-width: 1200px; border: 1px solid #e3e6f0;">
                    ...
                    <tbody>
                        ...
                        <tr class="animate__animated animate__fadeIn" style="animation-delay: <?php echo e($n * 0.03); ?>s; border-bottom: 1px solid #e3e6f0; transition: all 0.3s ease;">
                            ...
                            <td class="text-center fw-bold py-3" style="border-right: 1px solid #e3e6f0;">
                                <?php if($sp->comparison_percentage >= 80): ?>
                                <span class="badge bg-success rounded-pill px-3 py-2 shadow-sm"><?php echo e($sp->comparison_percentage); ?>%</span>
                                <?php elseif($sp->comparison_percentage >= 50): ?>
                                <span class="badge bg-warning rounded-pill px-3 py-2 shadow-sm"><?php echo e($sp->comparison_percentage); ?>%</span>
                                <?php else: ?>
                                <span class="badge bg-danger rounded-pill px-3 py-2 shadow-sm"><?php echo e($sp->comparison_percentage); ?>%</span>
                                <?php endif; ?>
                            </td>
                            <td class="text-center fw-bold py-3" style="border-right: 1px solid #e3e6f0;">
