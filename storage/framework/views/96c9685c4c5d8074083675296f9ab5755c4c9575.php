            ...
            <div class="table-responsive rounded-3 shadow-sm">
                <table id="resiembraTable" class="table table-hover align-middle mb-0" style="border: 1px solid #e3e6f0;">
                    ...
                    <tbody>
                        ...
                        <tr class="animate__animated animate__fadeIn" style="animation-delay: <?php echo e($n * 0.03); ?>s; border-bottom: 1px solid #e3e6f0; transition: all 0.3s ease;" data-id="<?php echo e($item->id); ?>">
                            ...
                            <td class="py-3" style="border-right: 1px solid #e3e6f0;">
                                ...
                                <span class="text-muted" data-bs-toggle="tooltip" title="<?php echo e($item->description); ?>"><?php echo e(Str::limit($item->description, 30)); ?></span>
                                <?php else: ?>
                            ...
                            <td class="text-center py-3" style="border-right: 1px solid #e3e6f0;">
                                <span class="badge bg-blue rounded-pill px-3 py-2 shadow-sm pulse-active"><?php echo e($item->status); ?></span>
                            </td>
...
<?php echo $__env->make('acuaponico::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sicefa\Modules/ACUAPONICO\Resources/views/admin/registroresiembras.blade.php ENDPATH**/ ?>